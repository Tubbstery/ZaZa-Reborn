...
#include "bytes.h" // for loading fonts from memory.
...
void render::init() {
	...
	esp_small = Font(XOR("04b03"), 8, FW_LIGHT, FONTFLAG_ANTIALIAS | FONTFLAG_OUTLINE);
	esp_small2 = Font(XOR("04b03"), 12, FW_LIGHT, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
	...
	logevent = menu;//Font(XOR("Lucida Console"), 12, FW_NORMAL, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
	Goofy = Font(XOR("Tahoma"), 12, FW_BOLD, FONTFLAG_DROPSHADOW);
	Goofy2 = Font(XOR("Tahoma"), 12, FW_MEDIUM, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
}
