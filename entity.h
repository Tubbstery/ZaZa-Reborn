...
public:
	...
	__forceinline void InvalidatePhysicsRecursive(int change_flags) {
		using InvalidatePhysicsRecursive_t = void(__thiscall *)(decltype(this), int);
		g_csgo.InvalidatePhysicsRecursive.as< InvalidatePhysicsRecursive_t >()(this, change_flags);
	}
...
public:
	...
	int			m_dispatch_sequence{};
	int			m_second_dispatch_sequence{};
